...
class Simulation:
    ...
    def simuler_meilleur_mouvement(self, iterations=1):
        ...
        for pion in pions:
            print(f"Je verifie",self.plateau.peut_manger(pion),capture_possible)            
            if not self.plateau.peut_manger(pion) and capture_possible:
              print(f"Je passe bro",self.plateau.peut_manger(pion),capture_possible)
              continue
